...
<head>
    ...
    <style>
        ...
        .table-container { background: white; border-radius: 15px; padding: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); }
        .tab-pane { transition: all 0.4s ease-in-out; }
        .fade { opacity: 0; transform: translateX(15px); }
        .fade.show { opacity: 1; transform: translateX(0); }
        .nav-pills .nav-link.active { background-color: #0A2540 !important; transform: scale(1.05); }
...
<div class="container mt-4 mb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small">Rastreo de actividades del sistema</p>
        </div>
        
        <button onclick="confirmarLimpieza()" class="btn btn-danger shadow-sm">
    ...
    <ul class="nav nav-pills justify-content-center mb-4" id="pills-tab" role="tablist">
        <li class="nav-item">
            <button class="nav-link active rounded-pill px-4" id="tab-login" data-bs-toggle="pill" data-bs-target="#content-login" type="button" role="tab">
                <i class="bi bi-person-lock me-2"></i> Accesos
            </button>
        </li>
        <li class="nav-item">
            ...
            <div class="table-container shadow-sm">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        <thead>
                            <tr><th>Fecha/Hora</th><th>Usuario</th><th>Acción</th><th>IP</th></tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            <?php endwhile; else: ?>
                                <tr><td colspan="4" class="text-center py-4 text-muted">Historial vacío.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="tab-pane fade" id="content-forms" role="tabpanel">
            <div class="table-container shadow-sm">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        <thead>
                            <tr><th>Fecha/Hora</th><th>Usuario</th><th>Acción</th><th>Detalle</th><th>IP</th></tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            <tr>
                                ...
                                <td style="max-width: 250px;"><small><?= htmlspecialchars($row['detalle']) ?></small></td>
                                <td><code><?= $row['ip'] ?></code></td>
                            </tr>
                            <?php endwhile; else: ?>
                                <tr><td colspan="5" class="text-center py-4 text-muted">Historial vacío.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
...
function confirmarLimpieza() {
    if (confirm("¡ATENCIÓN! ¿Estás seguro de que deseas borrar TODO el historial de auditoría? Esta acción no se puede deshacer.")) {
